...
inline std::pair<std::string,std::string> split_tenant(const std::string& bucket_name){
                         ...
                         bucket_instance_ls& stale_instances)
{
  ...
  // all the instances
  std::pair<std::string,std::string> tnt_bkt_pair = split_tenant(bucket_name);
  const std::string& tenant = tnt_bkt_pair.first;
  const std::string& bucket = tnt_bkt_pair.second;
