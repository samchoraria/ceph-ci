...
int main(int argc, char **argv)
{
  ...
  desc.add_options()
    ...
    ("op", po::value<string>(&op),
     "Arg is one of [info, log, remove, mkfs, fsck[-deep], repair[-deep], fuse, dup, export, import, list, fix-lost, list-pgs, rm-past-intervals, dump-journal, dump-super, meta-list, "
  ...
  if (!vm.count("objcmd") && op != "export" && op != "info" && op != "log" && op != "rm-past-intervals" && op != "mark-complete") {
    cerr << "Must provide --op (info, log, remove, mkfs, fsck[-deep], repair[-deep], export, import, list, fix-lost, list-pgs, rm-past-intervals, dump-journal, dump-super, meta-list, "
