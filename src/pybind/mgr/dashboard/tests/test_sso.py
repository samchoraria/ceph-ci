...
<md:EntityDescriptor xmlns:md="urn:oasis:names:tc:SAML:2.0:metadata"
  ...
  <md:IDPSSODescriptor protocolSupportEnumeration="urn:oasis:names:tc:SAML:2.0:protocol">
    ...
    def test_sso_saml2_setup(self):
        result = self.exec_cmd('sso-saml2-setup',
    ...
    def test_sso_enable(self):
        with self.assertRaises(CmdException) as ctx:
            self.exec_cmd('sso-enable')
        ...
        self.exec_cmd('sso-saml2-setup',
                      ceph_dashboard_base_url='https://cephdashboard.local',
                      idp_metadata=self.IDP_METADATA)

        result = self.exec_cmd('sso-enable')
    ...
    def test_sso_saml2_show(self):
        result = self.exec_cmd('sso-saml2-show')
