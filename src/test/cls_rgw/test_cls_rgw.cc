...
{
  // case recover: PUT Op fail to complete, index_suggest should recover the index
...
{
  // case race put: list op raced with put op, index_suggest should not delete index
...
{
  // case race delete: list op raced with del op, index_suggest should not recover put index
