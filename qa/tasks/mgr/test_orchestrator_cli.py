...
class TestOrchestratorCli(MgrTestCase):
    ...
    def _test_orchestrator_cmd(self, *args, **kwargs):
        return self.mgr_cluster.mon_manager.raw_cluster_cmd("test_orchestrator", *args, **kwargs)
    ...
    def test_load_data(self):
        ...
        self._test_orchestrator_cmd('load_data', '-i', '-', stdin=json.dumps(data))
        ...
        self._test_orchestrator_cmd('load_data', '-i', '-', stdin='{}')
